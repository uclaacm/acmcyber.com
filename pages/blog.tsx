  ...
  return (
    <div className="page">
      ...
      <p>
        ...
        rutrum purus ex ac mauris. Vestibulum blandit justo a diam semper, ac
        imperdiet nisi sagittis. Pellentesque habitant morbi tristique senectus
        et netus et malesuada fames ac turpis egestas. Maecenas felis justo,
        egestas quis purus a, suscipit egestas lorem. Suspendisse potenti.
        Aenean magna lorem, auctor in commodo et, rutrum vel justo. Donec
        sodales magna in eleifend pellentesque. Sed et pharetra est. Aenean
        faucibus leo et convallis laoreet. Phasellus ullamcorper, tortor eget
        accumsan lobortis, velit libero egestas lorem, auctor cursus lorem elit
